    ...
    <div className="home-footer">
      <div className="footer-container">
        ...
        <div className="footer-section">
          ...
          <ul>
            <li>
              <Link to="#">Đặt lịch khám</Link>
            </li>
            <li>
              <Link to="#">Lịch sử khám</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="footer-section">
          ...
          <div className="social-links">
            ...
            >
              ...
              >
                <path
                  d="M185.3 58.9c-11.4-6.5-19.8-17.4-22.9-30.4h-23.5v118.6c0 16.1-13.1 29.2-29.2 29.2s-29.2-13.1-29.2-29.2S93.6 118 109.7 118c2.6 0 5.2.4 7.6 1.1V93.7c-2.5-.3-5.1-.5-7.6-.5-30.8 0-55.7 25-55.7 55.7 0 24.7 16.1 45.6 38.4 52.8 5.5 1.8 11.4 2.8 17.6 2.8 30.8 0 55.7-25 55.7-55.7V80c10.9 7.6 24.1 11.9 38.2 11.9V66.8c-7.1-.2-14.2-2-20.7-5.3z"
                  fill="#25F4EE"
                />

                <path
                  d="M185.3 58.9c-11.4-6.5-19.8-17.4-22.9-30.4h-23.5v118.6c0 16.1-13.1 29.2-29.2 29.2-10.7 0-20.2-5.7-25.5-14.2-2.7-4.4-4.2-9.5-4.2-15 0-16.1 13.1-29.2 29.2-29.2 2.6 0 5.2.4 7.6 1.1V93.7c-2.5-.3-5.1-.5-7.6-.5-30.8 0-55.7 25-55.7 55.7 0 24.7 16.1 45.6 38.4 52.8 5.5 1.8 11.4 2.8 17.6 2.8 30.8 0 55.7-25 55.7-55.7V80c10.9 7.6 24.1 11.9 38.2 11.9V66.8c-22.8-.7-41.2-19.4-41.2-41.5z"
                  fill="#FF0050"
                  opacity="0.9"
                />
        ...
        <div className="footer-section">
          <h4>Hỗ trợ</h4>
          <button onClick={handleSupportClick} className="support-btn">
            Liên hệ hỗ trợ
          </button>
        </div>
      </div>
